...
<!-- Mirrored from keenitsolutions.com/products/html/educavo/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 06:34:11 GMT -->
<head> 
        <!-- meta tag -->
        <meta charset="utf-8">
                        ...
                        <div class="main-part">                           
                            <div class="method-account">
                                ...
                                <form name="f1" action = "contact.php" onsubmit = "return validation()" method = "POST">
                                    <input type="email" id="name" name="email" placeholder="E-mail" required="">
