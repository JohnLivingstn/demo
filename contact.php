...
<!-- Mirrored from keenitsolutions.com/products/html/educavo/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 06:34:16 GMT -->
<head> 
        <!-- meta tag -->
        <meta charset="utf-8">
                                         ...
                                         <ul class="nav-menu">
                                            <li class="rs-mega-menu mega-rs menu-item-has-children"> <a href="index-2.html">Home</a>
                                             ...
                                             <li class="menu-item-has-children current-menu-item">
                                                 <a href="#">Contact</a>
                                                 <ul class="sub-menu">
                                                    <li class="active"><a href="contact.html">Contact One</a> </li>
                                             ...
                                             <li class="menu-item-has-children current-menu-item">
                                                 <a href="#">Table</a>
                                                 <ul class="sub-menu">
                                                    <li class="active"><a href="table.php">Table One</a> </li>
                                                    <li class="active"><a href="tableone.php">Table Two</a> </li>
                                                    <li class="active"><a href="table_two.php">Table Three</a> </li>
                                                 </ul>
                                             </li>
                                         </ul> <!-- //.nav-menu -->
                                      </nav>                                        
									...
									<fieldset>
										<div class="row">
                                            ...
                                            <div class="col-lg-6 mb-35 col-md-6 col-sm-6">
                                                <input class="from-control" type="text" value="<?php echo $name?>" id="name" name="name" placeholder="Name" required="">
                                            </div> 
                                            <div class="col-lg-6 mb-35 col-md-6 col-sm-6">
                                                <input class="from-control" type="email" value="<?php echo $email?>" id="email" name="email" placeholder="Email" required="">
                                            </div>   
                                            <div class="col-lg-6 mb-35 col-md-6 col-sm-6">
                                                <input class="from-control" type="text" value="<?php echo $email ?>" id="phone" name="phone" placeholder="Phone" required="">
                                            </div>   
                                            <div class="col-lg-6 mb-35 col-md-6 col-sm-6">
                                                <input class="from-control" type="text" value="<?php echo $subject ?>" id="subject" name="subject" placeholder="Subject" required="">
                                            </div>
                                         
                                            <div class="col-lg-12 mb-50">
                                                <textarea class="from-control" value="<?php echo $message ?>" id="message" name="message" placeholder=" Message" required=""></textarea>
                                            </div>
										</div>
...
<!-- Mirrored from keenitsolutions.com/products/html/educavo/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 06:34:18 GMT -->
</html>